...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'DBMaintenance_Index_Stats', 
		...
		@notify_level_page=0, 
		@delete_level=0, 
		@description=N'Using ola.hallengren script running the DB Maintenance script for Index without Stats Update', 
...
BEGIN  
	...
	@FragmentationLevel1 = 20,@FragmentationLevel2 = 30,@FillFactor = 80, @PageCountLevel = 100,@LogToTable = ''''Y'''',	@SortInTempdb = ''''Y'''''', 	@database_name=N''msdb'', 	@flags=0, @MaxDOP=8' 
